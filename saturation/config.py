...
class RunConfig:
    ...
    # Number of timesteps
    num_timesteps: int = 100 #changed from 100
    ...
    cross_attn_64_range: Range = Range(start=20, end=100) #best parameter: 20:100; old=10:90
    # Timesteps to apply cross-attention on 32x32 layers
    cross_attn_32_range: Range = Range(start=20, end=100) #best parameter: 20:100; old=10:70
    # Timesteps to apply AdaIn (start=20, end=100)
    adain_range: Range = Range(start=30, end=100)
    # Swap guidance scale
    swap_guidance_scale: float = 3.5 # our opt value = 5
